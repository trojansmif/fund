...
insert into public.members (username, full_name, team, role, is_admin) values
  ...
  ('hungjui.chen',            'Hungjui ''Ryan'' Chen',        'Executive Committee',       'Chief Economist + US Economics Lead',                           true),
  ('kuan-wei.huang',          'Kuan-Wei (David) Huang',       'Executive Committee',       'Chief Technology Officer (CTO)',                                true),
  ...
  ('caleb.wang',              'Caleb Wang',                   'Directors',                 'Director of Risk Management + Rates and Sovereign Debt Lead',   false),
  ...
  ('arnav.dudeja',            'Arnav Dudeja',                 'Equity Sector Leads',       'Co-Energy + Utilities Lead',                                    false),
  ('alexander.chika-nwanja',  'Alexander Chika-Nwanja',       'Equity Sector Leads',       'Consumer Discretionary Lead',                                   false),
  ...
  ('vivian.wei',              'Vivian Wei',                   'Equity Sector Leads',       'Financials + Commodities & Crypto Lead',                        false),
  ...
  ('shawn.chen',              'Shawn Chen',                   'Fixed Income',              'Fixed Income Analyst',                                          false),
